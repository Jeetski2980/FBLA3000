    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="bg-white/10 border border-white/20 rounded-[40px] p-10 shadow-2xl">
          <div className="w-12 h-12 bg-primary/20 rounded-2xl flex items-center justify-center text-white mb-6">
            <Target size={24} />
          </div>
          <h2 className="text-2xl font-black mb-4 tracking-tight uppercase tracking-widest text-sm text-white">Our Mission</h2>
        ...
        <div className="bg-white/10 border border-white/20 rounded-[40px] p-10 shadow-2xl">
          ...
          <h2 className="text-2xl font-black mb-4 tracking-tight uppercase tracking-widest text-sm text-white">Our Vision</h2>
          <p className="text-2xl leading-relaxed text-white italic font-serif">
